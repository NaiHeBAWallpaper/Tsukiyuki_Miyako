...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Future Lab.flac';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	...
	},
	{
		...
		startTimes: [500],
		dialog: {
			Japanese: ["ふふっ、作戦中に油断なんてダメなのですけど……。"],
			English: ["Heehee, don't tell the others I let my guard down during a mission."],
			Chinese: ["诶嘿嘿，虽然说这在作战中是不被允许的……。"]
		}
	},
	{
		time: 30700,
		count: 4,
		startTimes: [500, 7000, 15500, 25200],
		dialog: {
			Japanese: [
				"……えっと……急なのですが、先生……。",
				"その……いつも一緒にいてくださって、ありがとうございます。",
				"先生がいらっしゃらなかったら……私も、RABBIT小隊も、ここまで成長できなかったと思います。",
				"なので今度、よろしければ、その――"
			],
			English: [
				"Well, um... This is out of nowhere, but, Sensei...",
				"Umm... Thank you for...always being there.",
				"If you hadn't been...The RABBIT Squad would never have come this far.", 
				"So, from now on, if you're okay with it...please..."
			],
			Chinese: [
				"……那个……虽然有点突然，老师…….",
				"呃……谢谢您一直陪伴在我们身边。",
				"如果没有老师的话……我和RABBIT小队也就不会成长至今……",
				"所以这次，如果可以的话，那个——"
			]
		}
	},
	{
		time: 19500,
		count: 4,
		startTimes: [500, 3800, 9000, 13500],
		dialog: {
			Japanese: [
				"……？連絡が……", 
				"なるほど、ここから500mの地点に……", 
				"はい。すぐに突入の準備を、とのことです。",
				"先生、ラペルリングとハーネスを装着してください。"
			],
			English: [
				"Huh? A message...",
	...
	},
	{
		...
		startTimes: [500],
		dialog: {
			Japanese: ["え？使い方がわからない……ですか？そ、そうでしたか……。"],
			English: ["Huh? You don't know how to? I...see..."],
			Chinese: ["诶？不知道该怎么弄……？这，这样啊……。"]
		}
	},
	{
		time: 15000,
		...
		dialog: {
			Japanese: [
				"……大丈夫です。では、ここで待っててください。すぐに終えて戻ってきます。",
				"それでまた先生と、ゆっくりこの夜景が見たいので。"
...
const HITBOX = {
	headpat: { xMin: 1650, xMax: 2150, yMin: 30, yMax: 330 },
	voiceline: { xMin: 1600, xMax: 2300, yMin: 700, yMax: 1500 }
};

const INTRO_TIMEOUT = 19500;
const HEADPAT_CLAMP = 30;
const EYE_CLAMP_X = 200;
const EYE_CLAMP_Y = EYE_CLAMP_X * (10 / 16);
